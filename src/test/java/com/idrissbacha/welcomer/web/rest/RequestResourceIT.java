...
class RequestResourceIT {
    ...
    void createRequest() throws Exception {
        ...
        assertThat(testRequest.getIsValid()).isEqualTo(DEFAULT_IS_VALID);
        assertThat(testRequest.getIsDelivered()).isEqualTo(DEFAULT_IS_DELIVERED);
    ...
    void putNewRequest() throws Exception {
        ...
        Request testRequest = requestList.get(requestList.size() - 1);
        assertThat(testRequest.getIsValid()).isEqualTo(UPDATED_IS_VALID);
        assertThat(testRequest.getIsDelivered()).isEqualTo(UPDATED_IS_DELIVERED);
    ...
    void partialUpdateRequestWithPatch() throws Exception {
        ...
        partialUpdatedRequest.createdDate(UPDATED_CREATED_DATE);
